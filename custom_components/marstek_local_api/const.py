...
DEFAULT_SCAN_INTERVAL: Final = 5  # Base interval in seconds
...
UPDATE_INTERVAL_FAST: Final = 1  # ES, Battery status (5s)
UPDATE_INTERVAL_MEDIUM: Final = 1  # EM, PV, Mode every cycle
UPDATE_INTERVAL_SLOW: Final = 10  # Device, WiFi, BLE (50s)
